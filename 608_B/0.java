...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int sum_zero[] = new int[b.length()];
        sum_zero[0] = b.charAt(0) == '0' ? 1 : 0;
        int sum_one[] = new int[b.length()];
        sum_one[0] = b.charAt(0) == '1' ? 1 : 0;
        for (int i = 1; i < b.length(); i++) {
            sum_zero[i] = sum_zero[i - 1] + (b.charAt(i) == '0' ? 1 : 0);
            sum_one[i] = sum_one[i - 1] + (b.charAt(i) == '1' ? 1 : 0);
        }
        // for (int i = 0; i < b.length(); i++) {
        //     System.out.print(sum_zero[i] + "_" + sum_one[i] + " ");
        // }
        // System.out.println();
        long ans = 0;
