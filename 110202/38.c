...
long get_hand_value(int hand[5]) {
		...
		//포카더
		else if (value[1]==value[4]|| value [3]==value[0])
					result = (8<<20)+(value[1]<<16);
		//풀하우스
		else if (value[2]==value[4] && value[0]==value[1])
					result = (7<<20)+(value[2]<<16);
		else if (value[3]==value[4] && value[0]==value[2])
		...
		//스트레이트
		else if(value[0]==value[1]+1&&value[0]==value[2]+2&&value[3]+3==value[0]&&value[0]==value[4]+4)
					result=(5<<20)+(value[0]<<16);
		
		//쓰리카드
		else if(value[2]==value[0]||value[2]==value[4]||value[1]==value[3])
					result=(4<<20)+(value[2]<<16);
		
		//투페어
		else if(value[1]==value[2]&&value[3]==value[4])
					result= (3<<20)+(value[1]<<16)+(value[3]<<12)+(value[0]<<8);
		else if(value[0]==value[1]&&value[4]==value[3])
					result = (3<<20)+(value[1]<<16)+(value[3]<<12)+(value[2]<<8);
		else if(value[0]==value[1]&&value[3]==value[2])
