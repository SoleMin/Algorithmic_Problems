...
def DFS(current_state, final_state, graph):
    ...
    while len(queue)!=0:
        ...
        if n1==0:
          if -1 < graph[9][n2][n3][n4] < 1 and [9,n2,n3,n4] not in queue:
            graph[9][n2][n3][n4] = graph[n1][n2][n3][n4] + 1
            queue.append([9,n2,n3,n4])
        else:
          if -1 < graph[n1-1][n2][n3][n4] < 1 and [n1-1,n2,n3,n4] not in queue:
            graph[n1-1][n2][n3][n4] = graph[n1][n2][n3][n4] + 1
            queue.append([n1-1,n2,n3,n4])
        ...
        if n2==0:
          if -1 < graph[n1][9][n3][n4] < 1 and [n1,9,n3,n4] not in queue:
            graph[n1][9][n3][n4] = graph[n1][n2][n3][n4] +1
            queue.append([n1,9,n3,n4])
        else:
          if -1 < graph[n1][n2-1][n3][n4] < 1 and [n1,n2-1,n3,n4] not in queue:
            graph[n1][n2-1][n3][n4]=graph[n1][n2][n3][n4]+1
            queue.append([n1,n2-1,n3,n4])
        ...
        if n3==0:
          if -1 < graph[n1][n2][9][n4] < 1 and [n1,n2,9,n4] not in queue:
            graph[n1][n2][9][n4]=graph[n1][n2][n3][n4]+1
            queue.append([n1,n2,9,n4])
        else:
           if -1 < graph[n1][n2][n3-1][n4]< 1 and [n1,n2,n3-1,n4] not in queue:
            graph[n1][n2][n3-1][n4]=graph[n1][n2][n3][n4]+1
            queue.append([n1,n2,n3-1,n4])
        ...
        if n4==0:
          if -1 < graph[n1][n2][n3][9] < 1 and [n1,n2,n3,9] not in queue:
            graph[n1][n2][n3][9]=graph[n1][n2][n3][n4]+1
            queue.append([n1,n2,n3,9])
        else:
          if -1 < graph[n1][n2][n3][n4-1] and [n1,n2,n3,n4-1] not in queue:	
            graph[n1][n2][n3][n4-1]=graph[n1][n2][n3][n4]+1
            queue.append([n1,n2,n3,n4-1])
